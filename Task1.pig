/** This script is to find the count of complaints that were given timely response **/
...
/** To get only those records that were given timely response **/
complaintsWithTimelyResponse = FILTER complaintDetails BY timelyResponse == 'Yes';

/** Grouped complaints by ID to discard duplicates in the data **/
distinctComplaints = GROUP complaintsWithTimelyResponse BY complaintId;
...
STORE count INTO '/abhilasha/Project2.2.Task1';
